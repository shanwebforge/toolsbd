...
export default function DesignerToolsPage() {
  const tools = getToolsByCat('designer-tools');
    ...
    <div className="max-w-7xl mx-auto px-4 py-10 md:p-10">
      ...
      <div className="mb-10 space-y-3">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white">
          Premium <span className="text-purple-600">Designer Tools</span>
        </h1>

        {/* Description with Indigo Accent on hover/links if needed */}
        <p className="text-gray-500 dark:text-zinc-400 max-w-2xl text-sm md:text-base leading-relaxed">
          Unlock your creativity with our curated collection of design utilities. From color 
          palettes to image optimization, we provide the essentials to bring your vision to life.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {tools.length > 0 ? (
          ...
          <div className="col-span-full py-20 text-center border-2 border-dashed border-indigo-100 dark:border-indigo-900/30 rounded-3xl">
            <Brush size={40} className="mx-auto text-purple-300 mb-4" />
            <p className="text-gray-400 italic font-medium">No tools found in this category.</p>
          </div>
        )}
      </div>
    </div>
