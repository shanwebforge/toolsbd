...
async function loadmarketerPosts() {
      ...
      <div class="post-content">
        ...
        <div class="post-actions-line">
          <div class="reactions">
            ...
            <span class="shareBtn" data-title="${post.title}" data-desc="${post.description}" data-url="/blog/post.html?id=${postId}&cat=posts_marketer"><i class="fas fa-share-alt"></i> Share</span>
          </div>
  ...
  document.querySelectorAll('.likeBtn').forEach(btn => {
    btn.onclick = async () => {
      const ref = doc(db, "posts_marketer", btn.dataset.id);
