...
async function loadtoolsPosts() {
  ...
  if (snapshot.empty) {
    container.innerHTML = "<p>No tools posts found.</p>";
    return;
  }
      ...
      <div class="post-content">
        ...
        <div class="post-actions-line">
          <div class="reactions">
            ...
            <span class="shareBtn" data-title="${post.title}" data-desc="${post.description}" data-url="/blog/post.html?id=${postId}&cat=posts_tools"><i class="fas fa-share-alt"></i> Share</span>
          </div>
